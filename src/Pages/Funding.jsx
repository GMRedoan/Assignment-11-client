    ...
    return (
        <div className="min-h-screen px-4 py-10 flex flex-col items-center">
             <div className="w-full max-w-5xl flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl md:text-4xl font-bold mb-2">Funding <span className="text-primary">History</span></h1>
                    <p className="text-accent">
                        View all funds contributed by users in 2025
                    </p>
                </div>
                {/* btn */}
                <Link to='/fundForm' className="btn btn-sm md:btn-md btn-primary text-white flex items-center gap-2">
                    <FaPlus />
                    Give Fund
                </Link>
            </div>
                ...
                <table className="table table-zebra w-full">
                    ...
                    <tbody>
                        {allFunding?.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="3" className="text-center text-accent py-4">
